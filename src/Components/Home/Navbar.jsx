...
const Navbar = () => {
   ...
   // const [visible, setVisible] = useState({ isBoxVisible: false })
   // const P = () => {
   //    const ref = useRef()

   //    const toggleBox = (e) => {
   //       let gr = e.target.classList.value = e.target.classList.value + ' d-none'
   //       console.log(e.target.classList)
   //       console.log("This is e target ", gr)
   //       //   let hel = e.target.classlist = "profile"
   //       // console.log(hel)

   //       setVisible((prevState) => {
   //          visible.isBoxVisible !== true ? setVisible({ isBoxVisible: true }) : setVisible({ isBoxVisible: false })
   //       });
   //       return gr
   //    };
   //    return (
   //       <div className="App d-flex mt-5">
   //          <div className="d-flex " style={{ flexDirection: "row" }}>
   //             <button ref={ref} className={` p-2 btn btn-primary  m-2 `} onClick={toggleBox}>Show Box</button>
   //             <button ref={ref} className=" p-2 btn btn-warning  m-2" onClick={toggleBox}>Show Box</button>
   //          </div>


   //          <div className={`box ${visible.isBoxVisible ? "" : "d-none"}`}>
   //             <p>I'm the box</p>
   //          </div>
   //          <div className={`box ${visible.isBoxVisible ? "" : "d-none"}`}>
   //             <p>I'm the box</p>
