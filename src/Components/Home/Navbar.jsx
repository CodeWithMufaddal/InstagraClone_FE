...
const Navbar = () => {
   ...
   return (
      ...
      <nav className="_a84r _a84s">
         {/* <div className="_a844" ></div> */}
         <div className="_9zxa _9zxc">
            <div className="_9z_7">
               <div className="_9z_9">


                  <div className="_a418">
                     <Link to="/" role="link" tabIndex="0" className="oajrlxb2 g5ia77u1 qu0x051f esr5mh6w e9989ue4 r7d6kgcz rq0escxv nhd2j8a9 nc684nl6 p7hjln8o kvgmc6g5 cxmmr5t8 oygrvhab hcukyx3x jb3vyjys rz4wbd8a qt6c0cv9 a8nywdso i1ao9s8h esuyzwwr f1sip0of lzcic4wl _a6hd">
                        <div className="_a1bn  _9-f2 _9-f5 _9-fd _9-fi _9-fm">
                           <div className='_9_pk'>
                              <i data-visualcompletion="css-img" aria-label="Instagram" role="img" className="sp_jY02qVAhKr8 sx_98e64d" ></i>
                  ...
                  <div className=" _a3pi _a4tf">
                     <input aria-label='Search input' autoCapitalize="none" className="_9_uj _a4th  _a4tk" type="text" placeholder="Search" />
                     <div className=" _a4tc" >
                        <div className="_9_uc">
                           <div className="_a4td">
                              <svg aria-label='Search' className="_9zn7" color="#8e8e8e" fill="#8e8e8e" height="16" role="img" viewBox="0 0 24 24" width="16">
                           ...
                           <span className="_9_uh _a4te">Search</span>
                        </div>
                     </div>
                     <div className="_9-rq"></div>
                  </div>

                  <div className="_9z_c _a419">
                     <div className="_a41a">

                        {/* ************************** ICONS ************************** */}
                        <div className="_9z_6"> {/* Home Icon */}
                           <div className="_a8y2">
                              <Link to="/home" role="link" tabIndex="0" className="oajrlxb2 g5ia77u1 qu0x051f esr5mh6w e9989ue4 r7d6kgcz rq0escxv nhd2j8a9 nc684nl6 p7hjln8o kvgmc6g5 cxmmr5t8 oygrvhab hcukyx3x jb3vyjys rz4wbd8a qt6c0cv9 a8nywdso i1ao9s8h esuyzwwr f1sip0of lzcic4wl _a6hd" >

                                 {location.pathname !== "/" && location.pathname !== "/home" ?
                                    <svg aria-label="Home" className="_9zn7" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <div className="_9z_6"> {/* Direct Icon */}
                           <Link to="/direct" aria-label={`Direct messaging - 0 new notification link`} role="link" tabIndex="0"
                              className="oajrlxb2 g5ia77u1 qu0x051f esr5mh6w e9989ue4 r7d6kgcz rq0escxv nhd2j8a9 nc684nl6 p7hjln8o kvgmc6g5 cxmmr5t8 oygrvhab hcukyx3x jb3vyjys rz4wbd8a qt6c0cv9 a8nywdso i1ao9s8h esuyzwwr f1sip0of lzcic4wl _9zkv _a6hd"
                           >

                              {location.pathname !== "/direct" ?
                                 <svg aria-label="Messenger" className="_9zn7" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <div className="_9z_6"> {/* Post Icon */}
                           <div className="_9-oh">
                              <button className="_9-mn _9-mo" type="button" tabIndex="0" >
                                 <div className="_9-mq">
                                    ...
                                    {location.pathname !== "/newPost" ?
                                       ...
                                       :
                                       <svg aria-label="New Post" className="_9zn7" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <div className="_9z_6"> {/* Explore Icon */}
                           <Link to="/explore" role="link" tabIndex="0" className="oajrlxb2 g5ia77u1 qu0x051f esr5mh6w e9989ue4 r7d6kgcz rq0escxv nhd2j8a9 nc684nl6 p7hjln8o kvgmc6g5 cxmmr5t8 oygrvhab hcukyx3x jb3vyjys rz4wbd8a qt6c0cv9 a8nywdso i1ao9s8h esuyzwwr f1sip0of lzcic4wl _a6hd"  >
                              {location.pathname !== "/explore" ?
                                 <svg aria-label="Find people" className="_9zn7" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    ...
                                    <circle cx="12.001" cy="12.005" r="10.5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></circle>
                                 </svg>
                                 :
                                 <svg aria-label="Find people" className="_9zn7" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <div className="_9z_6">   {/* Activity Feed Icon */}
                           <div className="_a8y0">

                              <Link to="/activityFeed" role="link" tabIndex="0"
                                 className="_9_hj _9zo3"  >
                                 {location.pathname !== "/activityFeed" ?
                                    <svg aria-label="Activity Feed" className="_9zn7" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    ...
                                    :
                                    <svg aria-label="Activity Feed" className="_9zn7" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 48 48" width="24">
                        ...
                        <div className="_9z_6"> {/* Profile Icon */}

                           <div className="dropdown ">

                              <button className=" profileLink _a8wx" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                              ...
                              <ul className="dropdown-menu " aria-labelledby="dropdownMenuButton2">
                                 ...
                                 <li>
                                    <a className=" profileDropdownInnerText oajrlxb2 g5ia77u1 qu0x051f esr5mh6w e9989ue4 r7d6kgcz rq0escxv nhd2j8a9 nc684nl6 p7hjln8o kvgmc6g5 cxmmr5t8 oygrvhab hcukyx3x jb3vyjys rz4wbd8a qt6c0cv9 a8nywdso i1ao9s8h esuyzwwr f1sip0of lzcic4wl _9-4g _a6hd" href="/profile">
                                       <div className=" _a1bn  _9-f2 _9-f5 _9-fd _9-fi _9-fm  _9-fx _9-g5 _9_j5 _9-ij ">
                                          <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm  _9-hg f-14" >
                                          ...
                                          <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fl">
                                             <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm">
                                                <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">
                                                   <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fm" style={{ height: " 28px", width: "170px" }}>
                                                      <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">Profile</div>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                 ...
                                 <li>
                                    <a className="dropdownLinks profileDropdownInnerText" href="#">
                                       <div className="_a1bn  _9-f2 _9-f5 _9-fd _9-fi _9-fm  _9-fx _9-g5 _9_j5 _9-ij">
                                          <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm  _9-hg f-14">
                                          ...
                                          <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fl">
                                             <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm">
                                                <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">
                                                   <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fm" style={{ height: " 28px", width: "170px" }}>
                                                      <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">Saved</div>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                 ...
                                 <li>
                                    <a className="dropdown-item profileDropdownInnerText" href="#">
                                       <div className="_a1bn  _9-f2 _9-f5 _9-fd _9-fi _9-fm  _9-fx _9-g5 _9_j5 _9-ij">
                                          <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm  _9-hg f-14">
                                          ...
                                          <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fl">
                                             <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm">
                                                <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">
                                                   <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fm" style={{ height: " 28px", width: "170px" }}>
                                                      <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">Settings</div>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                       ...
                                       <div className="_a1bn  _9-f2 _9-f5 _9-fd _9-fi _9-fm  _9-fx _9-g5 _9_j5 _9-ij">
                                          ...
                                          <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fl">
                                             <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm">
                                                <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">
                                                   <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fm" style={{ height: " 28px", width: "170px" }}>
                                                      <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">Switch Accounts</div>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                 ...
                                 <li><hr className="dropdown-divider _9zso" /></li>
                                 <li>
                                    <button type="button" className="dropdown-item profileDropdownInnerText" onClick={() => logOut()}>
                                       <div className="_a1bn  _9-f2 _9-f5 _9-fd _9-fi _9-fm  _9-fx _9-g5 _9_j6 _9-ij">
                                          <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fl">
                                             <div className="_a1bn  _9-f2 _9-f7 _9-fd _a8ww _9-fm">
                                                <div className="_9_68 _9_6b _9_6h _9_6j _9_6x">
                                                   <div className="_a1bn  _9-f2 _9-f7 _9-ff _a8ww _9-fm" style={{ height: " 28px", width: "170px" }}>
