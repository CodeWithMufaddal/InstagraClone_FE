      ...
      <nav className="navbar page-center">
         ...
         <div className="Navbar__quickLinks">
            <div className="Navbar__quickLinksInner">
               ...
               <Link to="/home" role="link" tabIndex="0" >   {/* Home Icon */}
               ...
               <Link to="/direct" aria-label={`Direct messaging - 0 new notification link`} role="link" tabIndex="0"  >  {/* Direct Icon */}
               ...
               <Link to="/newPost" role="link" tabIndex="0" >   {/* Post Icon */}
               ...
               <Link to="/explore" role="link" tabIndex="0"  >   {/* Explore Icon */}
               ...
               <Link to="/activityFeed" role="link" tabIndex="0" >  {/* Activity Feed Icon */}
               ...
               <Link className='profileLink' to="/profile" role="link" tabIndex="0">
